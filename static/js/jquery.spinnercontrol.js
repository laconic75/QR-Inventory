...
//            return inputControl;
        ...
        ($("div.ValueDisplay", objContainerDiv)).css({ 'min-width': opt.width });
		  ($("div.ValueDisplay", objContainerDiv)).click(function(){
		  		inputControl.css('display', 'inline');
		  		inputControl.focus();
		  		inputControl.select();
		  		inputControl.blur(function(){
		  			selectedValue = parseInt(inputControl.val(),10);		  			
					($("div.ValueDisplay", objContainerDiv)).html(selectedValue);
					//alert(selectedValue + opt.typedata.interval)
					inputControl.css('display', 'none');		  			
		  			});
		  	});
